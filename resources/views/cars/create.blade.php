...
<div class="container" style="width: 30%; margin:auto;">
     <form method="POST" action="cars/{car}" class="mt-5">
          @csrf
          <h1 class="mb-3">Забронировать автомобиль <br> {{$car->name}}</h1>
          <div class="mb-3">
               <label for="" class="form-label text-light">Имя</label>
               <input name="name" class="form-control" id="">
             </div>
          <div class="mb-3">
            <label name="number" for="" class="form-label text-light">Телефон</label>
            <input type="password" name="number" class="form-control" id="">
          </div>
          <div class="mb-3">
               <label  for="" class="form-label text-light">Количество суток</label>
               <input type="password" name="days" class="form-control" id="">
             </div>
